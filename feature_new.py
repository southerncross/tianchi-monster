...
for line in fp:
    ...
    # no bought info
    if i_time < 1418918400:
        # added to cart within 10 days
        if bt == '3' and 1418054400 < i_time:
            ui_cart[(ui, ii)][1] += 1
        # added to cart within 5 days
        if bt == '3' and 1418486400 < i_time:
            ui_cart[(ui, ii)][2] += 1
        # added to cart within 2 days
        if bt == '3' and 1418745600 < i_time:
            ui_cart[(ui, ii)][3] += 1
        # collected within 10 days
        if bt == '2' and 1418054400 < i_time:
            ui_cart[(ui, ii)][4] += 1
        # collected within 5 days
        if bt == '2' and 1418486400 < i_time:
            ui_cart[(ui, ii)][5] += 1
        # collected within 2 days
        if bt == '2' and 1418745600 < i_time:
            ui_cart[(ui, ii)][6] += 1
        # viewed within 10 days
        if bt == '1' and 1418054400 < i_time:
            ui_cart[(ui, ii)][7] += 1
        # viewed within 5 days
        if bt == '1' and 1418486400 < i_time:
            ui_cart[(ui, ii)][8] += 1
        # viewed within 2 days
        if bt == '1' and 1418745600 < i_time:
            ui_cart[(ui, ii)][9] += 1
        # bought within 10 days
        if bt == '4' and 1418054400 < i_time:
            ui_cart[(ui, ii)][10] += 1
        # bought within 5 days
        if bt == '4' and 1418486400 < i_time:
            ui_cart[(ui, ii)][11] += 1
        # bought within 2 days
        if bt == '4' and 1418745600 < i_time:
            ui_cart[(ui, ii)][12] += 1
